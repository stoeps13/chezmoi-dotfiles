...
# Replace these variables with your actual ServiceNow username and password
username = '{{ (bitwarden "item" "HCL Support (Bosch)").login.username }}'
password = '{{ (bitwarden "item" "HCL Support (Bosch)").login.password }}''

# URL of the ServiceNow page with the ?EXCEL parameter
#url = 'https://support.hcltechsw.com/sn_customerservice_case_list.do?sysparm_nostack=true&sysparm_first_row=1&sysparm_query=GOTOu_internal_status_1%3e%3dnot+closed&sysparm_query_encoded=GOTOu_internal_status_1%3e%3dnot+closed&sysparm_view=csp&EXCEL'
url = 'https://support.hcltechsw.com/sn_customerservice_case_list.do?sysparm_nostack=true&sysparm_query=GOTOu_external_action_status_2%3E%3Dhcl%20working&sysparm_first_row=1&sysparm_view=csp&EXCEL'
