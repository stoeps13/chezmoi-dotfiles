...
# Found at https://git.jonathanh.co.uk/jab2870/Dotfiles
...
pandoc -f markdown -t html5 --standalone --template ~/.config/neomutt/templates/email.html "$markdownFile" > "$htmlFile"
